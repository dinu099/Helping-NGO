		...
		<body id=\"page-top\">
			...
			<header>
				<div class=\"header-content\">
					<div class=\"header-content-inner\">
						<h1 id=\"homeHeading\">Volunteer List</h1>
							<hr>
							<p>Table contains list of volunteers along with area to be assigned to them.</p>
			...
			<section id=\"list\">
				<div class=\"container\">
					<div class=\"row\">
						<center>
							<form action=\"arrangeUpdate.php\" method=\"POST\">
								<table class=\"table table-bordered\">
									  ...
									  <tbody>";
									   include_once("selectedArea.php");
									 echo" </tbody>
									</table><br>
									<input type=\"submit\" name=\"view\" value=\"Confirm\" class=\"btn btn-primary btn-xl\" style=\"width:250px;\">
							</form>
						</center>
					</div>
				</div>
