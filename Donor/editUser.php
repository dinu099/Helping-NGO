			...
			<!-- Page Wrapper -->
					<div id=\"page-wrapper\">
						...
						<!-- Main -->
							<article id=\"main\">
								<header>
									<h2 style=\"font-size:25px; padding-top:-100px;\">Personal Details</h2>
									<center>
									<div class=\"login\">
										<form action=\"userManager.php\" method=\"POST\">
										  Name: <input type=\"text\" name=\"name\" value=\"{$row['name']}\">
										  <br>
										  Email: <input type=\"text\" name=\"email\" value=\"{$row['email']}\" readonly>
										  <br>
										  Mobile no:<input type=\"text\" name=\"contact\" value=\"{$row['contact']}\"maxlength=\"10\">
										  <br>
