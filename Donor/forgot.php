						...
						<!-- Main -->
							<article id=\"main\">
								<header>
									...
									<h2 style=\"font-size:25px; padding-top:-100px;\">Recover Password</h2>
									<center>
									<div class=\"login\">
										<form action=\"recover.php\" method=\"POST\">
										<div class=\"login1\" style=\"width:600px;\">
											<input type=\"email\" name=\"user_mail\" placeholder=\"Email address\" required>
										</div>
										<br>
										<div class=\"login1\">
											<input type=\"submit\" name=\"user_login\" value=\"Reset\"><br><br>
										</div>
										</form> 
									</div>
									</center>
